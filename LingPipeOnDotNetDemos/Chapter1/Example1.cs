...
#pragma warning restore
            ...
            {
                Util.consoleInputPrintClassification(classifier, japaneseSentence);
            ...
            {
                Util.consoleInputPrintClassification(classifier, englishSentence);
                //clrsystem.Console.WriteLine(classification.bestCategory());
            }

            string spanishSentence = "la lluvia en España cae principalmente en el llano.";
            {
                Util.consoleInputPrintClassification(classifier, spanishSentence);
                //clrsystem.Console.WriteLine(classification.bestCategory());
            }
